...
class AppStyles {
  ...
  static TextStyle semi16MainDarkColor = GoogleFonts.poppins(
    fontSize: 16,
    fontWeight: .w700,
  ...
  static TextStyle medium20WhiteDarkColor = GoogleFonts.poppins(
    fontSize: 20,
    fontWeight: .w500,
    color: AppColors.whiteDarkColor,
  );
  static TextStyle medium16MainLightColor = GoogleFonts.poppins(
    fontSize: 16,
    fontWeight: .w500,
    color: AppColors.mainLightColor,
  );
  ...
  static TextStyle regular16WhiteDarkColor = GoogleFonts.poppins(
    fontSize: 16,
    fontWeight: .w400,
    color: AppColors.whiteDarkColor,
  );
